...
#             "val",
#             "test",
#         ], "Split '{}' not supported for Clevrermac_mc".format(mode)
#         self.mode = mode
#         self.cfg = cfg  

#         logger.info("Constructing Clevrermac_mc {}...".format(mode))
#         self._construct_loader()

#         h5_path = os.path.join(cfg.DATA.PATH_TO_DATA_DIR, '{}_slow_features.hdf5'.format(mode))
#         self.f_h5 = h5py.File(h5_path, 'r')
#         self.res_fts = self.f_h5['data']
...
#         output_dict = {}
#         ft_i = self.get_ft_index(self._dataset[index]['video_path'])
#         output_dict['slow_ft'] = torch.from_numpy(self.res_fts[ft_i])
