"""
This script monitors memory usage and time for training a few batches.
Some functions were taken from: https://www.sicara.ai/blog/2019-28-10-deep-learning-memory-usage-and-pytorch-optimization-tricks
"""
