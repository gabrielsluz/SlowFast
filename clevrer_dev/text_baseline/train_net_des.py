...
#Clevrer specific
from slowfast.datasets.clevrer_text import Clevrertext, Clevrertext_des
...
def train_des(cfg):
    ...
    if cfg.TRAIN.DATASET != 'Clevrertext_des':
        print("This train script does not support your dataset: -{}-. Only Clevrertext_des".format(cfg.TRAIN.DATASET))
        exit()
    # Create the video train and val loaders.
